  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "sticky top-0 flex h-full min-h-svh w-(--sidebar-width) flex-col border-r border-muted/20 bg-background dark:border-muted/50",
          className
        )}
        {...props}
      >
...
const sidebarMenuButtonVariants = cva(
  "ring-sidebar-ring hover:text-sidebar-accent-foreground peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-full px-4 py-3 text-left text-sm font-medium text-muted outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-primary-foreground focus-visible:ring-2 active:bg-primary active:text-primary disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:bg-primary-foreground data-active:font-medium data-active:text-primary data-open:hover:bg-primary-foreground data-open:hover:text-primary-foreground dark:hover:bg-primary-foreground/10 dark:active:bg-primary/20 data-active:dark:bg-primary/20 [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
